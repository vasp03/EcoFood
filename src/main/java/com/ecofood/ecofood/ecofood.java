...
@Mod(ecofood.MODID)
public class ecofood {
    // Define mod id in a common place for everything to reference
    public static final String MODID = "ecofood";
    ...
    //Eco Steak
    public static final RegistryObject<Item> ECO_STEAK = ITEMS.register("eco_steak",
            () -> new Item(new Item.Properties().food(new FoodProperties.Builder()
                    .alwaysEat().nutrition(8).saturationMod(12f).build())));
    ...
    public static final RegistryObject<CreativeModeTab> EXAMPLE_TAB = CREATIVE_MODE_TABS.register("example_tab",
            () -> CreativeModeTab.builder()
                    ...
                    .displayItems((parameters, output) -> {
                        ...
                        output.accept(ECO_STEAK.get());
                        output.accept(MEAT_BLOCK_ITEM.get());
                    }).build());

    public ecofood(FMLJavaModLoadingContext context) {
